...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= $base_url."/".path_to_theme() ?>/skins/skin.css" />
    <link rel="stylesheet" type="text/css" href="<?= $base_url."/".path_to_theme() ?>/skins/style.css" />
    <!--[if lt IE 7]>
