...
like C<813.01> or C<815>.  With argument croak if the current version
...
This statement ensures that the scripts runs under ActivePerl 815 or
...
"ActivePerlEE" for the Enterprise Edition product.
