 ...
 * Package name      : perl5
 * Source directory  : 
 * Configuration time: Tue Jan 23 15:57:26 2007
 ...
 */
#define ARCHLIB "\usr\local\perl\\lib"		/**/
/*#define ARCHLIB_EXP ""	/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PRIVLIB "\usr\local\perl\\lib"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "\usr\local\perl\\site\\lib"		/**/
/*#define SITEARCH_EXP ""	/**/
 ...
 */
#define SITELIB "\usr\local\perl\\site\\lib"		/**/
