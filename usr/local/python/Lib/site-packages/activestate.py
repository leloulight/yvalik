#!/usr/bin/env python
# Copyright (c) 2002-2007 ActiveState Software Inc.  All rights reserved.
...
version_info = {'bsddb_ver': (4, 4, 20),
 'build_host': 'belt',
 'build_num': 1,
 'build_plat_fullname': 'win32-xp-x86',
 'build_plat_name': 'win32-x86',
 'build_time': 'Tue May 01 18:01:31 2007',
 'bzip2_ver': (1, 0, 3),
 'compiler': 'vc7-x86',
 'configuration': ['-f',
                   'apyconfig-apy25-rrun-win32-x86.py',
                   '-p',
                   'apy25',
                   '--build-tag',
                   'rrun'],
 ...
 'python_src': ('2.5.1', 'path', 'Python-2.5.1.tgz'),
 'pywin32_build': '209.2',
 'pywin32_src': ('20060922', 'path', 'pywin32-20060922-CRLF.zip'),
 'sqlite3_ver': (3, 3, 4),
 'tcltk_ver': (8, 4, 14),
 'tix_ver': (8, 4, 2),
 'with_bsddb': True,
...
compiler_info = """Microsoft (R) 32-bit C/C++ Optimizing Compiler Version 13.10.6030 for 80x86"""


# Used for Python install relocation.
prefixes = set([
    # Prefix to which extensions were built
    'C:\\trentm\\as\\ActivePython-devel\\build\\py2_5_1-win32-x86-apy25-rrun\\ExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIx',
    # Prefix to which Python sources were built.
    'C:\\trentm\\as\\ActivePython-devel\\build\\py2_5_1-win32-x86-apy25-rrun\\CoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIx'
])
shortest_original_prefix_length = 277
...
def _relocate_path(path, from_prefix, to_prefix, log):
    ...
    if is_binary:
        if sys.platform.startswith("aix"):
            ...
            pattern = re.compile("%s([^\0]*)\0" % re.escape(from_str))
