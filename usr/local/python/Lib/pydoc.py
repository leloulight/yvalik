...
class Helper:
    ...
    def __init__(self, input, output):
        ...
        for dir in [os.environ.get('PYTHONDOCS'),
                    ...
                    os.path.join(execdir, 'doc', 'python'),
...
running:
    hh -decompile . ActivePython%s%s.chm" in the %s\Doc
directory.
...
def cli():
    ...
    # ActivePython change: drop sys.path manipulate that breaks
    # 'python -m pydoc ...' usage.
